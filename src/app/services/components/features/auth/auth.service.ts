...
export class AuthService {
  ...
  onLogin: Subject<{email: string, password: string}> = new Subject<{email: string, password: string}>();
  onSignup: Subject<{firstName: string, lastName: string, email: string, username: string, password1: string, password2: string}> = new Subject<{firstName: string, lastName: string, email: string, username: string, password1: string, password2: string}>();
